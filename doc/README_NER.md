...
So, you have to convert your training corpora to the *CoNLL-U* format and put
your gold NE labels to the MISC field. For conversion, you can use the
...
Also, you have to accomplish morphological parsing prior to the NE tagger
training. If you make it with one of ***Morra*** taggers, you don't have to
worry about *CoNLL-U* conversion, because you'll get this format as the output
of the tagger.
