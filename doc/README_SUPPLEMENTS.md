...
If you want to predict only one exact field of *CoNLL-U*, you can pass more
specific methods to `.add()`. E.g., for the only POS field you may want to use
the method `.predict_pos2()`:
```python
